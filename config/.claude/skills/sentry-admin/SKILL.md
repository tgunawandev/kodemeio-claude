...
name: sentry-admin
description: >
  Sentry error tracking administration via kctl-sentry CLI (11 groups, ~29 commands).
  MUST use for ANY kctl-sentry operation.
  Triggers on: "alerts", "assign", "associate", "bulk-resolve", "check", "config", "dashboard", "deploy", "environments", "errors", "events", "generate", "health", "ignore", "init", "issues", "kctl-sentry", "overview", "profile", "projects", "releases", "resolve", "skill", "stats", "teams", "test".
  Auto-generated: 2026-04-05
  registry_hash: b3052752a631
---
