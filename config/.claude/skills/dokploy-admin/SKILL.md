...
description: >
  ...
  Manages projects, compose services, applications, deployments, domains,
  backups, environment variables, databases, registries, users, git providers,
  monitoring, notifications, certificates, and settings.
  Use when working with kctl-dokploy CLI or managing dokploy.kodeme.io.
version: 2.0.0
allowed-tools:
  - Bash
  - Read
