...
name: claw-admin
description: >
  OpenClaw AI agent gateway management via kctl-claw CLI (37 groups, ~160 commands).
  MUST use for ANY kctl-claw operation.
  Triggers on: "add-to-profile", "age-report", "agents", "agents-test", "ai", "al", "alerts", "allowlist", "audit", "backtest", "backup", "bc", "bench", "benchmark", "bindings", "bots", "canary", "check", "cl", "clear", "compare", "compare-models", "config", "config-drift", "cost", "credentials", "cron", "cron-debug", "current", "debug", "dedupe", "deploy", "diff", "disable", "docker", "doctor", "down", "dry-run", "du", "enable", "env", "errors", "export", "failures", "gateway", "generate", "health", "history", "hl", "init", "integration", "kctl-claw", "kill-switch", "latency", "lint", "logs", "lt", "mcp", "mcp-health", "mcp-test", "memory", "ml", "models", "monitor", "next", "optimize", "output", "pipeline", "portfolio", "profile", "profiles", "prompts", "protocol", "prune", "pull", "recent", "regression", "relevance", "reload", "remove".
  Auto-generated: 2026-04-05
  registry_hash: c09aece529d7
---

# claw-admin — kctl-claw CLI Reference

> Auto-generated from `kctl-claw` command registry. Do not edit manually.
> To regenerate: `kctl-claw skill generate`
...
```bash
kctl-claw config init       # Interactive setup
kctl-claw config show       # Show current config
kctl-claw config profiles   # List profiles
kctl-claw config current    # Show active profile
kctl-claw config validate   # Verify config
```
