...
description: >
  ...
  Covers user provisioning, group management, OAuth2/LDAP/SAML/Proxy
  provider setup, forward auth configuration, role-based access control,
  audit logging, and troubleshooting. Use when working with kctl-ak CLI
  or managing auth.kodeme.io.
version: 1.0.0
allowed-tools:
  - Bash
  - Read
